        ...
        <div class="card-body">
          ...
          <div class="container-fluid">
            <div class="row ">
              ...
              <div class="col-sm-3">
                <select class="form-control btn" name="pro" recquired id="pro" onchange="search_data(1)" style="width: 100%; border: 2px solid black;background-color: white;color: black;font-size: 16px;cursor: pointer; border-color: #7ADFB5;">
              ...
              <div class="col-sm-2">
                <!-- search button -->
                <button class="btn btn-block d-flex justify-content-left" id="search_btn" onclick="search_data_admin(1)" style="color:#fff;height:38px;border-radius:.25rem;background: #20c997;font-size:15px;font-weight:normal;"><img src="../../dist/img/search.png" style="height:19px;">&nbsp;&nbsp;Search</button>
              </div>
            </div>
            <br>
            <div class="col-12">
