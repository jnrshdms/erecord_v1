...
var realtime_load_notif_admin;
var realtime_load_notif_admin_page;

const load_notif_admin = () => {
  $.ajax({
    url: '../../process/notification/notif.php',
    type: 'POST',
    cache: false,
    data: {
      method: 'count_notif_admin'
    }, 
    success: response => {
        ...
        if (response_array.total > 0) {
          ...
          if (notif_approved_val != response_array.notif_approved) {
            ...
            $(document).Toasts('create', {
             ...
             update_notif_admin(); // AUTOCLEAR NOTIF
          }
        }
...
const update_notif_admin_badge = () => {
  $.ajax({
    url: '../../process/notification/notif.php',
    type: 'POST',
    cache: false,
...
// Notifications
const update_notif_admin = () => {
  $.ajax({
    url: '../../process/notification/notif.php',
    type: 'POST',
    cache: false,
    data: {
      method: 'update_notif_admin'
    },
    success: response => {
      if (response != '') {
        console.log(response);
