              ...
              <div class="tab-pane fade active show" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                <div class="d-flex">
                  <div class="mr-auto p-2">
                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#i_approve">
                      Approve
                    </button>
                  </div>
                  <div class="p-2">
                  ...
                  <div class="p-2"><input placeholder="Employee Name" type="text" id="emp_id_r" class="form-control" autocomplete="off"></div>
                  <div class="p-2"><input placeholder="Employee ID" type="text" id="fullname_r" class="form-control" autocomplete="off"></div>
