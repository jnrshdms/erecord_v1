    ...
    <ul class="navbar-nav ml-auto">
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
          ...
          <a href="dashboard.php" class="dropdown-item" id="notif_approval"><i class="fas fa-exclamation-circle mr-2"></i> no new request <span class="float-right text-muted text-sm"></span></a>
        </div>
      </li>
      <li class="nav-item">
