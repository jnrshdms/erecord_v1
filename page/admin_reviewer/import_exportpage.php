    ...
    <div class="card card-light" style="background: #fff; border-top: 2px solid #6c757d;">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-sm-4">
            <select class="from-control btn" name="pro" required id="pro" onchange="search_data(1)" style="width: 100%; border: 2px solid black;background-color: white;color: black;font-size: 16px;cursor: pointer; border-color: #7ADFB5;">
