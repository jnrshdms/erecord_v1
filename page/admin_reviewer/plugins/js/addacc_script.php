<script type="text/javascript">
	...
	//add account
	const save_acc_admin_r = () => {
		var fname = document.getElementById('fname_admin_r').value;
		var username = document.getElementById('username_admin_r').value;
		var role = document.getElementById('role_admin_r').value;
		var password = document.getElementById('password_admin_r').value;
		...
		if (fname == '') {
			...
			$.ajax({
				url: '../../process/accounts/add_admin_r.php',
				type: 'POST',
				cache: false,
				data: {
					method: 'save_acc_admin_r',
					fname: fname,
					username: username,
					password: password,
					role: role
				...
				success: function(response) {
					...
					if (response == 'success') {
						...
						$('#fname_admin_r').val('');
						$('#username_admin_r').val('');
						$('#password_admin_r').val('');
						load_accounts();
						$('#addadmin_r').modal('hide');
