...
//   }
//   $.ajax({
//     url:'../../process/listReq/disapprove.php',
//     type:'POST',
//     cache:false,
//     data:{
//     method:'fetch_dis',
...
// function rec_update_a(data, process) {
//     // You can customize this condition based on when you want to show the modal
//     if (process === 'your_desired_process_value') {
//         rec_update(data);
//         $('#admin_r_update').modal('show');
//     }
// } 
const handleCheckboxClick = (checkbox) => {
    const isCheckboxChecked = $(checkbox).is(':checked');

    console.log('Checkbox clicked. Checked:', isCheckboxChecked);

    if (isCheckboxChecked) {
        console.log('Checkbox is checked, update modal not shown');
        // You may add additional logic here if needed
        return;
    }

    console.log('Checkbox is not checked, showing update modal');

    // Access the data-update-modal-data attribute to get the update modal data
    const updateModalData = $(checkbox).data('update-modal-data');
    
    // You can use the updateModalData as needed
    console.log('Update Modal Data:', updateModalData);
    rec_admin_update(updateModalData);
};
