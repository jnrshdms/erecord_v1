...
if ($method == 'fetch_category') {
	...
	if (!empty($category)) {
		...
		$query = "SELECT a.r_approve_by,a.id,a.auth_no,a.auth_year,a.date_authorized,a.expire_date,a.r_of_cancellation,a.d_of_cancellation,a.remarks,a.updated_by,a.r_status,b.fullname,b.agency,a.dept,b.batch,b.emp_id,c.category,c.process";
